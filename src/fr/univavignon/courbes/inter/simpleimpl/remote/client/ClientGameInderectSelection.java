 ...
 */
public class ClientGameInderectSelection extends AbstractConnectionPanel implements ClientConnectionHandler
{	/** Numéro de série de la classe */
	...
	public ClientGameInderectSelection(MainWindow mainWindow)
	{	super(mainWindow,TITLE);
	}
	
	@Override
	public String getDefaultIp()
	{	String result = "168.269.11.1";
		return result;
	}
